...
import {AutoToolConversation, Backend, Engine, LiteRtLm, loadLiteRtLm, ContentPart, ToolWithImplementation, unloadLiteRtLm} from '@litert-lm/core';
// Placeholder for internal dependency on trusted resource url

jasmine.DEFAULT_TIMEOUT_INTERVAL = 1200_000;  // 20 minutes

const GPU_ARTISAN_MODEL_PATH = '/models/gemma4-e4b-hw.litertlm';

describe('AutoToolConversation E2E Integration tests', () => {
  ...
  describe('AutoToolConversation E2E', () => {
